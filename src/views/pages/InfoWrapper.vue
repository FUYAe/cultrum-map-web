<template>
  <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false"
    ...
    <svg @click="gohome" t="1666399616480" class="icon" viewBox="0 0 1024 1024" version="1.1"
      xmlns="http://www.w3.org/2000/svg" p-id="3599" width="30" height="30">
      <path
        ...
        p-id="3600" fill="#1296db"></path>
    </svg>
    <div class="flex-grow" />
    <!-- <el-menu-item index="1">Processing Center</el-menu-item> -->
    <el-menu-item @click="router.back">返回</el-menu-item>
